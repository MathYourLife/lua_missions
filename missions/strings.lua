...
It was the worst of times.
  ...
  -- starting new line character does not count
...
function test_string_upper()
  local alice = "drink me"
  assert_equal('DRINK ME', string.upper(alice))
end
...
function test_string_format_quoted_string_gets_escaped()
  local result = string.format('I told him: %q', 'Go "away"')
  assert_equal([[I told him: "Go \"away\""]], result)
end
